...
## Advanced Topics <a href="#advanced-topics-1" id="advanced-topics-1"></a>

* [Security Recommendations](advanced-topics-1/security-recommendations.md)
* [Nested Tokens](advanced-topics-1/nested-tokens.md)
* [Serialization](advanced-topics-1/serialization.md)
* [Custom Algorithm](advanced-topics-1/custom-algorithm.md)
* [Signed tokens and](advanced-topics-1/signed-tokens-and/README.md)
  * [Unprotected Header](advanced-topics-1/signed-tokens-and/unprotected-header.md)
  * [Multiple Signatures](advanced-topics-1/signed-tokens-and/multiple-signatures.md)
  * [Detached Payload](advanced-topics-1/signed-tokens-and/detached-payload.md)
  * [Unencoded Payload](advanced-topics-1/signed-tokens-and/unencoded-payload.md)
* [Encrypted tokens and](advanced-topics-1/encrypted-tokens-and/README.md)
  * [Unprotected Headers](advanced-topics-1/encrypted-tokens-and/unprotected-headers.md)
  * [Multiple Recipients](advanced-topics-1/encrypted-tokens-and/multiple-recipients.md)
  * [Additional Authentication Data (AAD)](advanced-topics-1/encrypted-tokens-and/additional-authentication-data-aad.md)
...
## Migration <a href="#migration-1" id="migration-1"></a>

* [From v1.x to v2.0](migration-1/from-v1.x-to-v2.0.md)
* [From v2.x to v3.0](migration-1/from-v1.x-to-v2.0-1.md)
