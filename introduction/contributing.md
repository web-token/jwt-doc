...
**If you think you have found a security issue, DO NOT open an issue**. [You MUST submit your issue here](https://github.com/web-token/jwt-framework/security/advisories).
