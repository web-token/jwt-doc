...
* through the dedicated console/standalone application ([see this page](../../console/index.md)),
...
The use of this feature is drastically different. JKUFactory and X5UFactory are now services that relies on [HttPlug](http://docs.php-http.org/en/latest/)
to get the key sets.
